    ...
    <header className="mb-12 mt-6 w-full text-black">
      <section className="flex w-full flex-col gap-y-10">
        <div className="flex items-center justify-between">
          <h2 className="text-[20px] font-semibold capitalize md:text-[25px] lg:text-[30px]">
        ...
        <div className="flex flex-col items-center text-center">
          <h3 className="w-full text-[20px] font-bold leading-[20px] md:text-[30px]">No tasks yet!</h3>
